...
public class MapEffectController : MonoBehaviour
{
    ...
    public void PlayUIEffect(GameObject targetGizmos, int effectID)
    {
        var temp = new GameObject();
        TransformHelper.ActiveWithStandardize(targetGizmos.transform, temp.transform);

        UI3DEffectTool.ShowBottomLayerEffect(UI3DEffectTool.UIType.FunctionUI_1, targetGizmos, EffectIdTemplate.GetPathByeffectId(effectID), temp, true);
    }
}
