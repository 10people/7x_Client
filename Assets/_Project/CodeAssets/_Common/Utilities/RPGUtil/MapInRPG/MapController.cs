...
public class MapController : MonoBehaviour
{
    ...
    public DelegateHelper.VoidDelegate m_ExecuteAfterOpenMap;
    public DelegateHelper.VoidDelegate m_ExecuteAfterCloseMap;
    ...
    public bool AddGizmos(int p_uID, int p_type, Vector3 p_position, float p_rotation)
    {
        ...
        gizmos.name += "_" + p_uID;
        TransformHelper.ActiveWithStandardize(transform, gizmos.transform);
