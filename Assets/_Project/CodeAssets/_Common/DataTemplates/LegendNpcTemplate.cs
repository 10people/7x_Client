...
using System.Xml;
using System.IO;
public class LegendNpcTemplate : XmlLoadManager {
	...
	public void Log(){
		Debug.Log( "LegendNpcTemplate-  id: " + id +
		          " id: " + NpcId + 
		          " EnemyId: " + EnemyId + 
	...
	public static void LoadTemplates( EventDelegate.Callback p_callback = null ){
		UnLoadManager.DownLoad( 
		                       PathManager.GetUrl( XmlLoadManager.m_LoadPath + "LegendNpcTemp.xml" ), CurLoad, UtilityTool.GetEventDelegateList( p_callback ), false );
	}
	...
	private static void ProcessAsset(){
		...
		do{
			t_has_items = t_reader.ReadToFollowing( "LegendNpcTemp" );
			
			if( !t_has_items ){
				break;
			}
			
			LegendNpcTemplate t_template = new LegendNpcTemplate();
	...
	public static bool HavelegendNpcTemplateByNpcId( int npcId ){
		{
			ProcessAsset();
		}

		foreach(LegendNpcTemplate t_item in templates)
		{
	...
	public static LegendNpcTemplate GetlegendNpcTemplate_By_npcid(int npc_id){
		{
			ProcessAsset();
		}
	...
	public static List<LegendNpcTemplate> GetLegendNpcTemplates_By_npcid(int npc_id){
		{
			ProcessAsset();
		}

		List<LegendNpcTemplate> temps = new List<LegendNpcTemplate> ();
	...
	public static LegendNpcTemplate GetLegendNpcTemplate_By_npcid_position(int npc_id, int position){
		{
			ProcessAsset();
		}
	...
	public static LegendNpcTemplate GetLegendNpcTemplat_By_EnemyId(int E_Id){
		{
			ProcessAsset();
		}
	...
	public static LegendNpcTemplate GetLegendNpcTemplate_By_id(int id){
		{
			ProcessAsset();
		}
