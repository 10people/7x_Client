...
public class LegendPveZuoBiaoTemplate  : XmlLoadManager {
	...
	public int Dir;
	public static List<LegendPveZuoBiaoTemplate> templates = new List<LegendPveZuoBiaoTemplate>();
	...
	public static void LoadTemplates( EventDelegate.Callback p_callback = null ){
		UnLoadManager.DownLoad(PathManager.GetUrl(m_LoadPath + "LegendPveZuobiao.xml"), CurLoad, UtilityTool.GetEventDelegateList( p_callback ), false );
	}
	...
	public static void CurLoad( ref WWW www, string path, Object obj ){
		...
		do{
			t_has_items = t_reader.ReadToFollowing( "LegendPveZuobiao" );
			
			if( !t_has_items ){
				break;
			}
			
			LegendPveZuoBiaoTemplate t_template = new LegendPveZuoBiaoTemplate();
	...
	public static Vector2 GetCoordinate( int p_section, int p_level ){
		for( int i = 0 ; i < templates.Count; i++ ){
			LegendPveZuoBiaoTemplate t_item = templates[ i ];
