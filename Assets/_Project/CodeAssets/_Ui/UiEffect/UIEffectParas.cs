...
public class UIEffectParas
{
    ...
    public static readonly Color ButtonHoverColor = new Color(1, 200 / 255.0f, 150 / 255.0f, 1);
    ...
    public static Vector3 WindowMinScale = Vector3.zero;
    public static Vector3 WindowsMaxScale = Vector3.one;
    public static float WindowsScaleDuration = 0.3f;
