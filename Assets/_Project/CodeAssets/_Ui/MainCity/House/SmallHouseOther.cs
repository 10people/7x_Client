...
/// 
/// </summary>
public class SmallHouseOther : HouseBasic, SocketListener
{
    public SmallHouseOtherEnter m_SmallHouseOtherEnter;
    ...
    public override void OnEnterClick()
    {
        ...
        m_SmallHouseOtherEnter.gameObject.SetActive(false);
