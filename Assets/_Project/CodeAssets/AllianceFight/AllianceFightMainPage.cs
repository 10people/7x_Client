...
//            Debug.Log("<");
    ...
    private IEnumerator ShowLeftTime()
    {
        if (leftTime == 0)
        {
...
//        Debug.Log("leftTime:" + leftTime);
    ...
    private void AllianceFightRecordLoadBack(ref WWW p_www, string p_path, Object p_object)
    {
...
//        GeneralControl.Instance.GeneralStoreReq(GeneralControl.StoreType.ALLIANCE_FIGHT, GeneralControl.StoreReqType.FREE);
    ...
    {
        PlayerSceneSyncManager.Instance.EnterAB();
    }
