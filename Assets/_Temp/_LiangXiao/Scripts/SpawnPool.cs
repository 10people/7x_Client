...
public sealed class SpawnPool : MonoBehaviour, IList<Transform>
{
    ...
    /// <summary>
    /// Read-only str access. You can still modify the instance at the given str.
    /// Read-only reffers to setting an str to a new instance reference, which would
    /// change the list. Setting via str is never needed to work with str access.
    /// </summary>
    ...
    /// The starting str for the copy operation. AddRange seems to pass the last str.
    /// </param>
