...
//		Debug.Log( "_Empty.OnDestroy()" );
	...
	public GameObject m_cur_hit_gb = null;
...
//			#endif
	...
	public void ObjectCall(){
		Debug.Log( Time.realtimeSinceStartup + " ObjectCall()" );
	}

	public static void StaticObjectCall(){
		Debug.Log( Time.realtimeSinceStartup + " StaticObjectCall()" );
	}
