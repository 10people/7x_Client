...
class Test_JSON_CSharp : MonoBehaviour
{
    ...
    void Test()
    {
		...
		Debug.Log( "1: " + I[ "NotExist" ] );

		I[ "NotExist_a" ] = I[ "NotExist_a" ] + "ABC";

		Debug.Log( "2: " + I[ "NotExist_a" ] );

		I[ "NotExist_a" ] = I[ "NotExist_a" ] + "DEF";

		Debug.Log( "3: " + I[ "NotExist_a" ] );
    }
