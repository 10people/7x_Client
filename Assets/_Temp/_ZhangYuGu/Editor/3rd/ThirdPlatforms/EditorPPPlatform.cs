...
public class EditorPPPlatform : MonoBehaviour {
	...
	[MenuItem("Build/Third Platform/PP Platform/Third Platform", false, 1)]
	public static void BuildPlatform(){
		...
		EditorBuild3rd.ProcessFolder (t_path, PP_PLATFORM_KIT_FOLDER_NAME);
	...
	[MenuItem("Build/Third Platform/PP Platform/Third Platform Project", false, 100)]
...
//		}
	...
	[MenuItem("Build/Settings/PP", false, 1)]
	public static void BuildSettings(){
		EditorBuild3rd.BuildSettings( "PP" );
