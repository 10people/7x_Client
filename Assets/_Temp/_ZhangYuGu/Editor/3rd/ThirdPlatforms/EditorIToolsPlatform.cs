...
public class EditorIToolsPlatform : MonoBehaviour {
	...
	[MenuItem("Build/Third Platform/ITools Platform/Third Platform", false, 1)]
	public static void BuildPlatform(){
		...
		EditorBuild3rd.ProcessFile ( t_path, ITOOLS_H_FOLDER_NAME );
		...
		EditorBuild3rd.ProcessFile ( t_path, PLATFORM_KIT_IMAGE_BUNDLE_FILE_NAME );
	...
	[MenuItem("Build/Third Platform/ITools Platform/Third Platform Project", false, 100)]
...
//		}
	...
	[MenuItem("Build/Settings/ITools", false, 1)]
