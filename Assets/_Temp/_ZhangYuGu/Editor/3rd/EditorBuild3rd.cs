...
public class EditorBuild3rd : MonoBehaviour {
	...
	[MenuItem("Build/Settings/GameGoo", false, 1)]
...
//	}
	...
	public static void ProcessFolder( string p_project_path, string p_relative_path ){
		...
		BuildUtility.DirectoryCopy( t_src, t_des );
	}
...
//		                         );
	...
	public static string GetPBXContent( BuildTarget p_target, string p_path_to_built_project ){
		string p_project_pbx = EditorBuild3rd.GetProjectPBXPath ( p_path_to_built_project );
